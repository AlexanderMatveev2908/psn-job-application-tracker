...
public class RecAad {
    ...
    public byte[] toBinary() {
        ...
        map.put("salt", Prs.binaryToHex(salt));
        map.put("userId", userId.toString());
        map.put("tokenId", tokenId.toString());

        return Prs.mapToBinary(map);
    }
